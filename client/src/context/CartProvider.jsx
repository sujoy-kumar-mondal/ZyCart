...
export const CartProvider = ({ children }) => {
  ...
  // =====================================================
  useEffect(() => {
    if (!user || user.role !== "user") return;  // ⛔ block for admin/supplier
  ...
  const removeFromCart = async (productId) => {
    ...
    if (user) {
      try {
        ...
        console.warn("DB remove error", err);
      }
    }
  };
  ...
  const updateQty = async (productId, qty) => {
    ...
    if (user) {
      try {
        ...
        console.warn("DB update qty error", err);
      }
    }
  };
