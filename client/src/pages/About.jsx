    ...
    <div className="max-w-screen-2xl container mx-auto px-14 py-16 space-y-16">
      ...
      >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Your trusted multi-supplier online marketplace built with modern
      ...
      >
        ...
        <p className="text-gray-700 leading-relaxed text-lg">
          ...
          suppliers. We believe in transparency, quality, and customer
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            To empower users and suppliers by providing a trusted, user-friendly
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            To become the most reliable and customer-centric multi-supplier
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="space-y-3">
            ...
            <p className="text-gray-600">
              Access to thousands of products from multiple trusted suppliers all
              in one place.
            </p>
          </div>
