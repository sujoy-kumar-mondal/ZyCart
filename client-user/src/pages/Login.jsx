...
const Login = () => {
  ...
  useEffect(() => {
    document.title = "Customer Login — ZyCart";
  }, []);
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-[#3F51F4]/40 focus:bg-white outline-none transition"
                />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full pl-10 pr-12 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold text-slate-900 placeholder-slate-400 focus:ring-2 focus:ring-[#3F51F4]/40 focus:bg-white outline-none transition"
                />
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4 pt-2">
            <div>
              ...
              <input
                ...
                autoFocus
                placeholder="000000"
                className="w-full py-3.5 px-4 bg-slate-50 border border-slate-200 rounded-2xl text-2xl font-black text-center tracking-widest text-[#1B2A41] focus:ring-2 focus:ring-[#3F51F4]/40 focus:bg-white outline-none transition"
              />
            </div>
