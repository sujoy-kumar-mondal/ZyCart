...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Maintain platform security with access control and monitoring",
      icon: Shield,
        ...
        <section className="py-20 bg-linear-to-r from-red-50 to-orange-50 border-y border-red-200">
          <div className="max-w-screen-2xl container mx-auto px-4 md:px-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <h3 className="text-lg font-bold text-[#1B2A41] mb-2">Access</h3>
                <p className="text-gray-600">
                  Fine-grained access control and permission management for different admin.
                </p>
              </motion.div>
