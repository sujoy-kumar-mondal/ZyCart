...
const ChangePassword = () => {
  ...
  useEffect(() => {
    document.title = "Change Password | Executive Administration";
    if (!user) {
          ...
          <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-[#0F172A] via-[#1A0B12] to-[#2B0E17] p-8 sm:p-10 flex-col justify-between relative border-r border-slate-800/70 overflow-hidden">
            ...
            <div className="space-y-6 relative z-10">
              <Link to="/admin/profile" className="inline-flex items-center gap-2 text-xs font-bold text-slate-400 hover:text-white transition group">
                <ArrowLeft className="w-4 h-4 group-hover:-translate-x-1 transition-transform" /> Back to Admin Profile
              </Link>
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-slate-400 font-medium leading-relaxed">
                  Administrator credentials command access to platform-wide governance, RBAC rules, financial settlements, and catalog operations.
                </p>
              </div>
              ...
              <div className="space-y-3 pt-2">
                <div className="p-3.5 rounded-2xl bg-slate-800/50 border border-slate-700/50 flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white">Privileged Operation Protection</h4>
                    <p className="text-[11px] text-slate-400">Ensures security during system settings and user bans.</p>
                  </div>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-slate-800/50 border border-slate-700/50 flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-xs font-bold text-white">Cryptographic Salt Standards</h4>
                    <p className="text-[11px] text-slate-400">Strict bcrypt iterations with immutable audit logs.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 pt-6 border-t border-slate-800/60 flex items-center gap-3">
              ...
              <div className="overflow-hidden">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded-md bg-red-500/20 text-red-400 border border-red-500/30">
